...
Poniższy diagram w formacie Mermaid wizualizuje strukturę projektu, grupując pliki według roli i pokazując wszystkie istniejące pliki `.jsx`. Strzałki wskazują zależności między komponentami a hookami.
